...
-}
module GraphRewriting.Graph.Write (module GraphRewriting.Graph.Write, module GraphRewriting.Graph.Types, module Data.View)
where
...
mergeEdges e1 e2 = when (e1 ≢ e2) $ do
 ...
 where
  replacePort p = if p ≡ e2 then e1 else p
